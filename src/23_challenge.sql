CREATE TABLE history_play_songs (
    id INTEGER AUTO_INCREMENT PRIMARY KEY, user_id INTEGER NOT NULL, FOREIGN KEY (user_id) REFERENCES users (id), song_id INTEGER NOT NULL, FOREIGN KEY (song_id) REFERENCES songs (id), played_at DATETIME NOT NULL
);
