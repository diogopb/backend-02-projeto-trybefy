CREATE TABLE plans (
    id INT PRIMARY KEY AUTO_INCREMENT, name VARCHAR(50) NOT NULL, price FLOAT(5, 2) NOT NULL
);
...
CREATE TABLE users (
    id INT PRIMARY KEY AUTO_INCREMENT, full_name VARCHAR(50) NOT NULL, email VARCHAR(50) UNIQUE NOT NULL, birthday DATE NOT NULL, active BOOLEAN NOT NULL DEFAULT true, plan_id INT NOT NULL, FOREIGN KEY (plan_id) REFERENCES plans (id)
);
