CREATE TABLE songs (
    id INTEGER PRIMARY KEY AUTO_INCREMENT, title VARCHAR(50) NOT NULL, duration_in_seconds INTEGER NOT NULL, album_id INTEGER NOT NULL, FOREIGN KEY (album_id) REFERENCES albums (id)
);
